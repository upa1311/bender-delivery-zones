...
| Probability sample | 133 reviewed of 400 | 47.37% descriptive unweighted; corrected two-phase Hájek estimate 55.73%; interval unavailable pending larger/completed review |
...
| Number reconciliation | 7 gross Yandex-only; 5 gross canonical-only; 4 paired substitutions; 3 unresolved | Known provisional net 0; unresolved rows excluded; not a city total |
