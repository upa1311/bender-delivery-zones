...
|---|---:|---:|---:|
| Canonical 9,216 sample | 2,565 | 17 | 117 |
| Recovered exclusion candidates | 36 | 36 | 36 |
| Combined forward observations | — | 53 | 153 |
...
| DIFFERENT_STREET | 1 |
| DIFFERENT_HOUSE_NUMBER | 55 |
| SETTLEMENT_ONLY | 7 |
| NOT_FOUND | 0 |
| NON_DELIVERABLE_STRUCTURE | 1 |
| DUPLICATE_EXISTING_ADDRESS | 16 |
| AMBIGUOUS_REQUIRES_REVIEW | 16 |

There are 56 explicit address disagreements: 1 different-street and 55
